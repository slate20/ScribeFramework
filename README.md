# ScribeFramework - Overview

## What is ScribeFramework?

ScribeFramework is a **Python web framework** that lets you write Python code directly in your templates, eliminating the boilerplate of traditional MVC frameworks while maintaining clean separation of concerns.
...
**ScribeFramework asks:** What if you could just write Python where you need it?
...
Can't do something with ScribeFramework helpers? Drop to Flask:
...
## What Makes ScribeFramework Different?
